...
import grupoConversando from './assets/grupo.png';
      	...
      	<main className="main-layout">
      		<section className="presentation-section">
      			<div className="presentation-text">
      				...
      				<h4> Às vezes, tudo o que você precisa é de um <span className="green-highlighted-font"> novo olhar</span> para encontrar 
						a <span className="green-highlighted-font"> força</span> que já está dentro de você. Liberte-se do peso da 
						<span className="green-highlighted-font"> mente</span> e 
						descubra uma nova forma de <span className="green-highlighted-font">viver.</span> </h4>
      			</div>
      		...
      		<section className="objetivos">
      			...
      			<div className="card-container"> 
      				...
      				<div className="card obj4"> 
      					...
      					<p> Fortalecer a rede de apoio social dos pacientes para 
							que se sintam conectados e apoiados na jornada de 
      				...
      				<div className="card obj5"> 
      					...
      					<p> Agendar  sessões com psicólogos e terapeutas de diversas
							 localidades, garantindo acesso a uma variedade
							  de especializações. </p>
      				</div>
      			</div>
      		</section>
